...
class Core(commands.Cog, name="일반"):
    ...
    async def myprofile(self, ctx):
        ...
        embed.add_field(
            name='가입일', value=f'{date.year}년{date.month}월{date.day}일', inline=False)
    ...
    async def invite(self, ctx):
        embed = discord.Embed(color=0x00FF21, title="봇초대 링크",
                              description="[초대하러 가기](https://discord.com/oauth2/authorize?client_id=704999866094452816&permissions=8&scope=bot)")
        embed.set_footer(text="bot made by. 미간#8269",
                         icon_url="https://cdn.discordapp.com/avatars/415135882006495242/cb4c1c1fce24f512e07f673989814572.webp?size=1024")
    ...
    async def uptime(self, ctx):
        ...
        embed = discord.Embed(color=0x00FF21, title=":up:업타임",
                              description=f"현재 업타임은 {hours}시간 {minitues}분 {seconds}초 입니다.")
        embed.set_footer(text="bot made by. 미간#8269",
                         icon_url="https://cdn.discordapp.com/avatars/415135882006495242/cb4c1c1fce24f512e07f673989814572.webp?size=1024")
    ...
    async def server(self, ctx):
        ...
        embed = discord.Embed(color=0x00FF21, title="Kubot의 서버수",
                              description=f"현재 Kubot의 서버수는 {len(self.bot.guilds)}서버 입니다.\n현재 한디리에서 Kubot서버가 1서버로 표기되고있습니다.")
        embed.set_footer(text="bot made by. 미간#8269",
                         icon_url="https://cdn.discordapp.com/avatars/415135882006495242/cb4c1c1fce24f512e07f673989814572.webp?size=1024")
        await message.edit(embed=embed)
    ...
    async def ping(self, ctx):
        ...
        embed = discord.Embed(
            color=0x00FF21, title=":ping_pong:퐁!",  description=f"{int(ping)}ms")
        embed.set_footer(text="bot made by. 미간#8269",
                         icon_url="https://cdn.discordapp.com/avatars/415135882006495242/cb4c1c1fce24f512e07f673989814572.webp?size=1024")
        await message.edit(embed=embed)
    ...
    async def hey(self, ctx):
        await ctx.send(random.choice(['뭐', '왜']))
